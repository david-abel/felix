# Elliot Mitchell and Dave Abel | Carleton College | felix.py |
...
def queryUser():
	...
	while num_measures.isdigit() != True or int(num_measures) > 100 and int(num_measures) < 0:
		print "Invalid Selection."
		num_measures = raw_input("Please select a reasonable number of measures (positive integer less than 100) ")
	...
	print
	mode = raw_input("Choose a mode for your song (1 is the Major scale, 6 is the Minor scale): ")
	...
	while not title.isalpha():
		...
		title = raw_input("What do you want your song to be called? (No spaces or funky characters allowed) ")
